...
public class ValidadorArgumento {
    ...
    public static void validarMayorIgual(Long numeroInicial, Long numeroFinal, String mensaje) {
        if (numeroInicial >= numeroFinal) {
            throw new ExcepcionValorInvalido(mensaje);
        }
    }
    public static void validarMenorIgual(Long numeroInicial, Long numeroFinal, String mensaje) {
        if (numeroInicial <= numeroFinal) {
            throw new ExcepcionValorInvalido(mensaje);
        }
    }
